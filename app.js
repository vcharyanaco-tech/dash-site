...
function initWorkspaceFeatures(){
  ...
  var gsi=getEl('globalSearchInput');
  if (gsi && !gsi.__dashSearchBound) {
    gsi.__dashSearchBound = true;
    gsi.addEventListener('input', function(){ renderGlobalSearch_(gsi.value); });
  }
