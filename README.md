...
| `aadhar.html` | Aadhaar MIS Reporting dashboard — Haryana Circle (PIN-gated login, served at `/aadhar.html`; includes the post-login MIS dashboard view — 11 reports, 4 access levels. Source lives in the separate `aadhar-dashboard` repo) |
