...
const validatorCases = [
  ...
  { fn: 'updateSubmission', goodArgs: ['sub123', 'New text', null, adminToken], badArgs: [], msg: /updateSubmission requires/ },
  { fn: 'updateSubmission', goodArgs: ['sub123', 'New text', null, adminToken], badArgs: [null, 'New text', null, adminToken], msg: /submissionId is required/ },
  { fn: 'updateSubmission', goodArgs: ['sub123', 'New text', null, adminToken], badArgs: ['sub123', '', null, adminToken], msg: /text is required/ },
  ...
  { fn: 'markNotificationsRead', goodArgs: ['all', adminToken], badArgs: [], msg: /markNotificationsRead requires/ },
  ...
  { fn: 'getNotificationPrefs', goodArgs: [adminToken], badArgs: [], msg: /getNotificationPrefs requires/ },
  { fn: 'setNotificationPrefs', goodArgs: [adminToken, {}], badArgs: [adminToken], msg: /setNotificationPrefs requires \(prefs, token\)/ },
  { fn: 'setNotificationPrefs', goodArgs: [adminToken, {}], badArgs: [adminToken, null], msg: /prefs must be an object/ },
